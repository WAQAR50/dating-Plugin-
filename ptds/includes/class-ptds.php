...
class Ptds {
	...
	private function define_admin_hooks() {
		...
		// Ajax function of check email 
		$this->loader->add_action( 'wp_ajax_ptds_datingemailcheck',  $plugin_admin, 'ptds_datingemailcheck' );
		$this->loader->add_action( 'wp_ajax_nopriv_ptds_datingemailcheck',  $plugin_admin, 'ptds_datingemailcheck' );
       ...
       // Save custom fields value
		...
		// update dating event ststus on date change
		 $this->loader->add_action('admin_init', $plugin_admin, 'ptds_dating_event_status_update', 10) ;
